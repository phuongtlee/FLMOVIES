...
class CartoonAnime extends StatefulWidget {
  const CartoonAnime({super.key});

  @override
  _CartoonAnimeState createState() => _CartoonAnimeState();
}

class _CartoonAnimeState extends State<CartoonAnime> {
  int page = 1;
  List movies = [];
  ...
  Future<void> fetchMovies() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://phimapi.com/v1/api/danh-sach/hoat-hinh?page=$page'),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Hoạt Hình')),
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            // Loại bỏ SizedBox giữa ảnh và box
            Container(
